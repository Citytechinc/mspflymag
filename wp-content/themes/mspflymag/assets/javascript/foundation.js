...
//this really only matters on the homepage. strange.
$('.sticky').on('sticky.zf.stuckto:top', function () {
    console.log("Selected!");
    $('.home .mobile-logo').addClass('invisible');
}).on('sticky.zf.unstuckfrom:top', function () {
    $('.home .mobile-logo').removeClass('invisible');
});
;'use strict';
